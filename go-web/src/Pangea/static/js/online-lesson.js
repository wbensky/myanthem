...
function init_left_menu(){
    ...
    for( var i = 0; i < map_nav["online-lesson"].length; i++) {
        var item_b = $("<b></b>");
        var item_li = $("<li></li>");
        item_li.attr("target", map_nav_link["online-lesson"][i]);
        item_b.html(map_nav["online-lesson"][i]);
...
exp_online_menu_function= {
    "circuit-theory":function(){},
    "subject-chair":function(){},
    "imitate-circuit":function(){},
    "electrician-circuit":function(){},
    "number-circuit":function(){},
    "circuit-analyse":function(){},
};
